...
function! ViewInBrowser(name)
    if expand("%:e") == "php" || expand("%:e") == "html" || expand("%:e") == "md"
        exe ":update"
        if g:iswindows
            ...
            let Firefox = "C:/Program Files (x86)/Mozilla Firefox/Firefox.exe"              "Firefox程序目录（可按实际更改）
...
if (g:iswindows)
    source $VIM/vimfiles/dq.vim
else
    source $HOME/.vim/dq.vim
endif
